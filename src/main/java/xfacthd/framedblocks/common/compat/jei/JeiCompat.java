...
public final class JeiCompat
{
    ...
    public static void init()
    {
        ...
        if (net.fabricmc.loader.api.FabricLoader.getInstance().getEnvironmentType() == net.fabricmc.api.EnvType.CLIENT && ModList.get().isLoaded("jei") && !ModList.get().isLoaded("rei_plugin_compatibilities"))
        {
            loadedClient = true;
        }
    }
