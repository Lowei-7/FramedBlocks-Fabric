...
public final class FramingSawRecipeCache
{
    ...
    private final Object2IntMap<Item> materialValues = new Object2IntOpenCustomHashMap<>(IDENTITY_STRATEGY);
    ...
    public static int sortRecipes(ItemStack resultOne, ItemStack resultTwo, IBlockType typeOne, IBlockType typeTwo)
    {
        ...
        String ns1 = net.minecraft.core.registries.BuiltInRegistries.ITEM.getKey(resultOne.getItem()).getNamespace();
        //noinspection ConstantConditions
        String ns2 = net.minecraft.core.registries.BuiltInRegistries.ITEM.getKey(resultTwo.getItem()).getNamespace();
