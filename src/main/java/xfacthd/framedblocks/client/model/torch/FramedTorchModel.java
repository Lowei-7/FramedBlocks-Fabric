...
public class FramedTorchModel extends FramedBlockModel
{
    ...
    {
        return ModelCache.getRenderTypes(Blocks.TORCH.defaultBlockState(), rand, null);
    }

    @Override
    protected void getAdditionalQuads(Map<Direction, List<BakedQuad>> quadMap, BlockState state, RandomSource rand, Object extraData, RenderType layer)
    {
