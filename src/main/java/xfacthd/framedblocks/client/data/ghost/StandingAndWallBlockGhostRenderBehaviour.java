...
{
    private static final MethodHandle BLOCKITEM_GETPLACESTATE = Utils.unreflectMethod(BlockItem.class, "method_7707", new String[]{"getPlacementState"}, BlockPlaceContext.class);
