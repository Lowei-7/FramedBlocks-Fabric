...
public final class ParticleHelper
{
    ...
    public static final class Client
    {
        ...
        )
        {
            ...
            // Use level random instead of engine.random (which is private)
            double x = bx + level.random.nextDouble() * (aabb.maxX - aabb.minX - 0.2) + 0.1D + aabb.minX;
            double y = by + level.random.nextDouble() * (aabb.maxY - aabb.minY - 0.2) + 0.1D + aabb.minY;
            double z = bz + level.random.nextDouble() * (aabb.maxZ - aabb.minZ - 0.2) + 0.1D + aabb.minZ;
